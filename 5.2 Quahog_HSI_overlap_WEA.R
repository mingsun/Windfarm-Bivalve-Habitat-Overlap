...
HSI_template <- rast(
  "../results/HSI/quahog/HSI_weighted/quahog_HSI_weighted_202501.tif"
)
plot(HSI_template)
...
writeRaster(
  WEA_raster,
  "../results/WEA_overlay/quahog_WEA_on_HSI_grid.tif",
  overwrite = TRUE
)
...
for (i in seq_along(months)) {
  ...
  write.csv(
    overlay_df,
    paste0(
      "../results/WEA_overlay/quahog_HSI_WEA_cell_overlay_2025",
      month_id,
      ".csv"
    ),
    row.names = FALSE
