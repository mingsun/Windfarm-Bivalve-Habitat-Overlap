...
tow_file <- "../data/quahog data/OQ_tows_MA_final.csv"
out_dir <- "../results/HSI/quahog"
...
write.csv(
  leave_one_year_validation_metrics,
  file.path(out_dir, "quahog_leave_one_year_validation_metrics.csv"),
  row.names = FALSE
)
