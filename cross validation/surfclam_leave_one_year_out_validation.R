...
tow_file <- "../data/surfclam data/SC_tows_MA_final.csv"
out_dir <- "../results/HSI/surfclam"
...
write.csv(
  leave_one_year_validation_metrics,
  file.path(out_dir, "surfclam_leave_one_year_validation_metrics.csv"),
  row.names = FALSE
)
