...
sediment_SI <- readRDS("../results/HSI/quahog/quahog_sediment_SI.rds")
depth_SI <- readRDS("../results/HSI/quahog/quahog_depth_SI.rds")
temp_SI <- readRDS("../results/HSI/quahog/quahog_temp_SI.rds")

# ------------------------------------------------------------ #

# 3. Load BRT weights ----

brt_weights <- read.csv("../results/HSI/quahog/quahog_BRT_weights.csv")
...
for (i in seq_along(temp_files)) {
  ...
  # save monthly HSI
  out_file <- paste0(
    "../results/HSI/quahog/HSI_weighted/quahog_HSI_weighted_2025",
    month_id,
    ".tif"
  )
...
write.csv(
  extrap_df,
  "../results/HSI/quahog/HSI_weighted/temperature_extrapolation_summary_2025.csv",
  row.names = FALSE
)
