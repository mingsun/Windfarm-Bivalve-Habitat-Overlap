...
survey_file <- "../data/scallop data/SS_tows_MA_final.csv"

hsi_dir <- "../results/HSI/scallop/HSI_weighted"
hsi_pattern <- "scallop_HSI_weighted_2025"
...
write.csv(
  validation_metrics_monthly,
  "../results/HSI/surfclam/surfclam_validation_metrics_summer_by_month.csv",
  row.names = FALSE
)
...
saveRDS(
  validation_df,
  "../results/HSI/surfclam/surfclam_validation_df_summer_by_month.rds"
)
# ----------------------------------------------------------------- #
