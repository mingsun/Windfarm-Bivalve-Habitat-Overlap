...
data <- read.csv("../data/surfclam data/SC_tows_MA_final.csv") |>
...
saveRDS(sediment_SI, "../results/HSI/surfclam/surfclam_sediment_SI.rds")
...
saveRDS(depth_SI, "../results/HSI/surfclam/surfclam_depth_SI.rds")
...
saveRDS(temp_SI, "../results/HSI/surfclam/surfclam_temp_SI.rds")
...
png(
  "../plot/2. SI curve/surfclam_SI.png",
  width = 6,
  height = 8,
  units = 'in',
  res = 800
...
write.csv(
  data,
  "../results/HSI/surfclam/SC_tows_with_separate_SI.csv",
  row.names = FALSE
)
...
data <- read.csv("../results/HSI/surfclam/SC_tows_with_separate_SI.csv") # load seperate SI
...
plot(brt_fit)
brt_fit$contributions # 60, 25, 15
brt_fit$n.trees
...
write.csv(
  brt_weights,
  "../results/HSI/surfclam/surfclam_BRT_weights.csv",
  row.names = FALSE
)
write.csv(
  data,
